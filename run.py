...
navbar = dbc.NavbarSimple(
    brand='PREDICTING GENDER FROM MORTALITY DATA',
    brand_href='/', 
    children=[
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Nick Burkhalter', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:nburkhal.nb@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/Nburkhal/US-Mortality-Project'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/nick-burkhalter-4b0377108/'),
                ], 
                className='lead'
            )
        )
